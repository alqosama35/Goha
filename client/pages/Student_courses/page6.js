let courses = [
  {
    title: "Arabic",
    description:
      "تعلم كل ما تحتاجه من النحو و القراءه و الكتابة في اللغه العربية",
    image:
      "https://i.pinimg.com/originals/75/3e/a5/753ea5478877595092520c0f53a52760.jpg",
    ...
    options: [
      {
        date: "2024-02-01",
        time: "9:00am - 12:00pm",
        teachers: ["Teacher E", "Teacher F"],
      },
      {
        date: "2024-02-08",
        time: "1:00pm - 4:00pm",
        teachers: ["Teacher G", "Teacher H"],
      },
    ],
  },
  {
    ...
    image:
      "https://th.bing.com/th/id/R.28e7c19d7b006d1361fe2736d6447cbb?rik=xmD9yS6%2bUtZTGA&riu=http%3a%2f%2flivingunabridged.com%2fwp-content%2fuploads%2f2016%2f01%2fbiology-1024x576.jpg&ehk=BXaClJF1tWW42dnHO9TBQKkG1kmTP4h6m2Ry6tjzda4%3d&risl=&pid=ImgRaw&r=0",
    availability: "Available",
    price: 100,
    options: [
      {
        date: "2024-03-01",
        time: "10:00am - 1:00pm",
        teachers: ["Teacher I", "Teacher J"],
      },
      {
        date: "2024-03-08",
        time: "2:00pm - 5:00pm",
        teachers: ["Teacher K", "Teacher L"],
      },
    ],
  },
  {
    ...
    image:
      "https://i.pinimg.com/736x/df/35/f8/df35f889f984a7abb3d40e0e4547ddf7.jpg",
    availability: "Available",
    price: 100,
    options: [
      {
        date: "2024-04-01",
        time: "9:00am - 12:00pm",
        teachers: ["Teacher M", "Teacher N"],
      },
      {
        date: "2024-04-08",
        time: "1:00pm - 4:00pm",
        teachers: ["Teacher O", "Teacher P"],
      },
    ],
  },
  {
    ...
    image:
      "https://th.bing.com/th/id/R.acd75934e4489f2d49986b1e33ca223a?rik=xLiDQWMlgtaDuQ&riu=http%3a%2f%2fst2.depositphotos.com%2f3351183%2f12376%2fv%2f450%2fdepositphotos_123762412-stock-illustration-chalk-drawing-physics-symbols-on.jpg&ehk=6mVcRkrKCQWID2rSqokirZU16sF%2fdvGzcJXbDEBkE6c%3d&risl=&pid=ImgRaw&r=0",
    availability: "Available",
    price: 100,
    options: [
      {
        date: "2024-05-01",
        time: "9:00am - 12:00pm",
        teachers: ["Teacher Q", "Teacher R"],
      },
      {
        date: "2024-05-08",
        time: "1:00pm - 4:00pm",
        teachers: ["Teacher S", "Teacher T"],
      },
    ],
  },
  {
    ...
    image:
      "https://yt3.ggpht.com/a/AATXAJyXdfYcOvsSL9SGVdPgKDzvVKqHWh8dIvxbwA=s900-c-k-c0xffffffff-no-rj-mo",
    availability: "Available",
    price: 100,
    options: [
      {
        date: "2024-06-01",
        time: "10:00am - 1:00pm",
        teachers: ["Teacher U", "Teacher V"],
      },
      {
        date: "2024-06-08",
        time: "2:00pm - 5:00pm",
        teachers: ["Teacher W", "Teacher X"],
      },
    ],
  },
];
...
function showCourseInfo(button) {
  ...
  if (currentCourse) {
    document.getElementById("course-info-title").textContent =
      currentCourse.title;

    const courseTeachers = currentCourse.options
      .map((option) => option.teachers.join(", "))
      .join(" / ");
    document.getElementById(
      "course-info-teachers"
    ).textContent = `Teachers: ${courseTeachers}`;

    const courseTimes = currentCourse.options
      .map((option) => `${option.date} (${option.time})`)
      .join(" or ");
    document.getElementById(
      "course-info-times"
    ).textContent = `Times: ${courseTimes}`;

    document.getElementById(
      "course-info-price"
    ).textContent = `Price: $${currentCourse.price}`; // Add price
...
function enrollCourseWithOption() {
    ...
    bannedCourse = localStorage.getItem("bannedCourse")
  if (!(email === "alqosama35@gmail.com")) {
...
document.getElementById("enroll-option-button").onclick =
  enrollCourseWithOption;
